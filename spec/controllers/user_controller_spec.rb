...
RSpec.describe UsersController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    it 'fails to create a user if no paramaters were passed' do
      post :create, params: {username: nil, email: nil, password: nil, password_confirmation: nil}
    ...
    it "fails to create a user if passwords don't match" do
      post :create, params: {username: 'alex', email: 'alex@goosd.com', password: 'ab12cd34', password_confirmation: '1122121'}
      expect(response).to have_http_status(500)
      parsed_response = JSON.parse(response.body)
